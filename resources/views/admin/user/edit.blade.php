@extends('layouts.admin.app', ['page' => __('User Management'), 'pageSlug' => 'admin.users'])
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group{{ $errors->has('role') ? ' has-danger' : '' }}">
                                        <label class="form-control-label" for="select-user-role">{{ __('Role') }}</label>
                                        <select name="role" id="select-user-role" class="form-control form-control-alternative" required>
