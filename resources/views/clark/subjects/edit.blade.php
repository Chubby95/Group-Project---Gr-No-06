            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">{{ __('Edit subject') }}</h3>
                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group{{ $errors->has('Title') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="Title" id="input-Title" class="form-control form-control-alternative{{ $errors->has('Title') ? ' is-invalid' : '' }}" placeholder="{{ __('Name') }}" value="{{ old('Title',$subject->Title) }}" required autofocus>
