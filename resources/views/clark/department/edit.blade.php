                            ...
                            <div class="col-md-6">
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group{{ $errors->has('department_name') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="department_name" id="input-department_name" class="form-control form-control-alternative{{ $errors->has('department_name') ? ' is-invalid' : '' }}" placeholder="{{ __('Name') }}" value="{{ old('department_name',$department->department_name) }}" required autofocus>
