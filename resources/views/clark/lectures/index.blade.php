            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-4 text-right">
                        <a href="{{ route('lectures.create') }}" class="btn btn-sm btn-primary">{{ __('Add lecture') }}</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table class="table tablesorter " id="">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $lecture->departments[0]->department_name }}</td>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            <form action="{{ route('lectures.destroy', $lecture) }}" method="post">
                                                ...
                                                <a class="dropdown-item" href="{{ route('lectures.edit', $lecture) }}">{{ __('Edit') }}</a>
